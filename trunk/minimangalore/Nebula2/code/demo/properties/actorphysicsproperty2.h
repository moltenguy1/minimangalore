#ifndef PROPERTIES_ACTORPHYSICSPROPERTY2_H
#define PROPERTIES_ACTORPHYSICSPROPERTY2_H
//------------------------------------------------------------------------------
/**
    @class Properties::ActorPhysicsProperty2

    ActorPhysicsProperty2 adds "actor physics" to an entity. This is
    mainly a capsule which is always kept upright and responds "immediately"
    to move messages. Attach the ActorPhysicsProperty2 instead of a
    PhysicsProperty to an entity.

    ActorPhysicsProperty2 implements the following messages:
...
{
class ActorPhysicsProperty2 : public AbstractPhysicsProperty
{
    DeclareRtti;
...
inline
bool
ActorPhysicsProperty2::IsGotoActive() const
{
