...
bool DemoGameState::CreatePlayer()
{
	...
	Ptr<Game::Property> pp = factoryManager->CreateProperty("ActorPhysicsProperty");
...
bool DemoGameState::CreateEnvironment()
{
	...
	nString resName("level/multilayer");
	...
	//collideFilename.Format("export:meshes/examples/%s_mlp_0.n3d2", resName.Get());
	collideFilename.Format("export:meshes/examples/multilayer_mlp_0.n3d2");
