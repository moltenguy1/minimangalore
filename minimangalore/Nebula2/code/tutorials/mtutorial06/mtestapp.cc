...
#include "mtutorial06/state/mtestgamestatehandler.h"
...
{
    return "Tutorial 06 : Applying Damage levels with texture replacement";
}
...
void mTestApp::SetupGui()
{
     ...
     // NOTA : this is already init at default val by SetupSubsystems
     // (so, yes, this not really usefull ....) the purpose is to show
     // how to set your own gui values
	...
	//will work on the default gui window
    ...
    textLabel->SetText( "\n\n\n\n\n\n\n\n" );	// only set to allow GetTextPolarent to return something...  
	vector2 textPolarent = textLabel->GetTextExtent();
    rectangle textRect(vector2(0.0f, 0.0f), textPolarent );
...
Ptr<Game::Property> damageProperty;
	...
	// attach the "damage" property
	damageProperty = Managers::FactoryManager::Instance()->CreateProperty("OpelDamageProperty");
    entity->AttachProperty( damageProperty );
...
Ptr<Game::Property> inputProperty;
	...
	// attach the new polarinputcameraproperty
    ...
    // and switch input to our entity
